...
module simple_hps_0_hps_io_border(
// memory
...
// hps_io
 ...
 ,output wire [1 - 1 : 0 ] hps_io_qspi_inst_SS3
 ,output wire [1 - 1 : 0 ] hps_io_qspi_inst_SS2
 ...
 ,input wire [1 - 1 : 0 ] hps_io_spis0_inst_CLK
 ,input wire [1 - 1 : 0 ] hps_io_spis0_inst_MOSI
 ,output wire [1 - 1 : 0 ] hps_io_spis0_inst_MISO
 ,input wire [1 - 1 : 0 ] hps_io_spis0_inst_SS0
...
assign hps_io_spis0_inst_MISO = intermediate[21] ? intermediate[20] : 'z;
assign hps_io_i2c0_inst_SDA = intermediate[22] ? '0 : 'z;
assign hps_io_i2c0_inst_SCL = intermediate[23] ? '0 : 'z;
assign hps_io_i2c3_inst_SDA = intermediate[24] ? '0 : 'z;
assign hps_io_i2c3_inst_SCL = intermediate[25] ? '0 : 'z;
...
,.QSPI_SS_N({
    hps_io_qspi_inst_SS3[0:0] // 3:3
   ,hps_io_qspi_inst_SS2[0:0] // 2:2
...
cyclonev_hps_peripheral_spi_slave spis0_inst(
 .SPI_SLAVE_TXD({
...
,.SPI_SLAVE_SCLK({
    hps_io_spis0_inst_CLK[0:0] // 0:0
  })
,.SPI_SLAVE_SS_N({
    hps_io_spis0_inst_SS0[0:0] // 0:0
  })
,.SPI_SLAVE_RXD({
    hps_io_spis0_inst_MOSI[0:0] // 0:0
  })
);
