	component simple is
		port (
			...
			hps_io_hps_io_qspi_inst_SS3       : out   std_logic;                                        -- hps_io_qspi_inst_SS3
			hps_io_hps_io_qspi_inst_SS2       : out   std_logic;                                        -- hps_io_qspi_inst_SS2
			...
			hps_io_hps_io_spis0_inst_CLK      : in    std_logic                     := 'X';             -- hps_io_spis0_inst_CLK
			hps_io_hps_io_spis0_inst_MOSI     : in    std_logic                     := 'X';             -- hps_io_spis0_inst_MOSI
			hps_io_hps_io_spis0_inst_MISO     : out   std_logic;                                        -- hps_io_spis0_inst_MISO
			hps_io_hps_io_spis0_inst_SS0      : in    std_logic                     := 'X';             -- hps_io_spis0_inst_SS0
			...
			hps_io_hps_io_i2c3_inst_SDA       : inout std_logic                     := 'X';             -- hps_io_i2c3_inst_SDA
			hps_io_hps_io_i2c3_inst_SCL       : inout std_logic                     := 'X'              -- hps_io_i2c3_inst_SCL
		);
	...
	u0 : component simple
		port map (
			...
			hps_io_hps_io_qspi_inst_SS3       => CONNECTED_TO_hps_io_hps_io_qspi_inst_SS3,       --                           .hps_io_qspi_inst_SS3
			hps_io_hps_io_qspi_inst_SS2       => CONNECTED_TO_hps_io_hps_io_qspi_inst_SS2,       --                           .hps_io_qspi_inst_SS2
			...
			hps_io_hps_io_spis0_inst_CLK      => CONNECTED_TO_hps_io_hps_io_spis0_inst_CLK,      --                           .hps_io_spis0_inst_CLK
			hps_io_hps_io_spis0_inst_MOSI     => CONNECTED_TO_hps_io_hps_io_spis0_inst_MOSI,     --                           .hps_io_spis0_inst_MOSI
			hps_io_hps_io_spis0_inst_MISO     => CONNECTED_TO_hps_io_hps_io_spis0_inst_MISO,     --                           .hps_io_spis0_inst_MISO
			hps_io_hps_io_spis0_inst_SS0      => CONNECTED_TO_hps_io_hps_io_spis0_inst_SS0,      --                           .hps_io_spis0_inst_SS0
			...
			hps_io_hps_io_i2c3_inst_SDA       => CONNECTED_TO_hps_io_hps_io_i2c3_inst_SDA,       --                           .hps_io_i2c3_inst_SDA
			hps_io_hps_io_i2c3_inst_SCL       => CONNECTED_TO_hps_io_hps_io_i2c3_inst_SCL        --                           .hps_io_i2c3_inst_SCL
		);
